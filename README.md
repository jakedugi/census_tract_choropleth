...
## This is designed to be helpful to anyone trying to create a highly granular interactive choropleth of the United States. ## 84,414 polygons. Jake Dugan 7 min read
...
# Example usage:
input_file = r'D:\code\tract\censustractdata\ACSST5Y2021.S2701-Data.csv'
output_file = r'D:\code\tract\censustractdata\Blog_Data.csv'
...
csv_file_path = 'D:/code/tract/censustractdata/Blog_Data.csv'
...
new_csv_file_path = 'D:/code/tract/censustractdata/New_Blog_Data.csv'
df.to_csv(new_csv_file_path, index=False)

# Example usage:
input_csv_file = r'D:/code/tract/censustractdata/Blog_Data.csv'
output_csv_file = r'D:/code/tract/censustractdata/Blog_Data_Processed.csv'
...
def catestvisual():
    ...
    csv_file = 'D:/code/tract/Blog_Data_Processed.csv'
    ...
    with open("D:/code/tract/codetract/accesstoken.txt", "r") as token_file:
    ...
    fig.write_html('D:/code/tract/visual/Blog_choropleth_map_FINAL.html')
    fig.show()
